        ...
        <div class="container">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">list keywords instansi </li>
            </ol>
          </section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">List of keywords instansi</h3>
                  <div class="box-tools">
                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
                        <th>Instansi</th>
                        <th>Keyword</th>
                        <c:url var="newKeyInstansiUrl" value="/newKeyInstansi" />           
                      <th><a href="${newKeyInstansiUrl}" title="new Keyword Instansi"><i class="fa fa-plus-circle fa-2x text-green"></i></a></th> 
                    </tr>
                    <c:forEach items="${keywords}" var="keyword">
                    <tr>
                        <td>${keyword.instansi.namaInstansi}</td>
                        <td>${keyword.namaKeyword}</td>
                        <td><a href="<c:url value='/edit-keyInstansi-${keyword.id}' />" title="edit">
                                <i class="fa fa-pencil text-blue"></i></a>&nbsp;
                            <a href="<c:url value='/delete-keyInstansi-${keyword.id}' />" title="remove">
